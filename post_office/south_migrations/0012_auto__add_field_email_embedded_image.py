...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Email.embedded_image'
        db.add_column(u'post_office_email', 'embedded_image',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Email.embedded_image'
        db.delete_column(u'post_office_email', 'embedded_image')
    ...
    models = {
        ...
        'post_office.email': {
            ...
            'embedded_image': ('django.db.models.fields.CharField', [], {'max_length': '255', 'blank': 'True'}),
